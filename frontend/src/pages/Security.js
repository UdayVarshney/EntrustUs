...
const Security = () => {
  ...
  return (
    <div class=" text-lg bg-white py-6 sm:py-8 lg:py-16 text-align:center w-full">
      <NormalHeader
      ...
      />
      <div class = 'bg-[#171A46]'>
      <section class="text-lg text-gray-500 body-font bg-white ">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="text-4xl mb-12 font-bold tracking-tight text-[#171A46] sm:text-5xl md:text-6xl">Securing your data at rest
            </h1>
      ...
      <section class="text-gray-500 body-font bg-white">
        <div class="container mx-auto flex px-5 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="text-4xl mb-12 font-bold tracking-tight text-[#171A46] sm:text-5xl md:text-6xl ">Securing your data in transit
            </h1>
      ...
      <section class="text-gray-500 body-font bg-white">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="text-4xl mb-12 font-bold tracking-tight text-[#171A46] sm:text-5xl md:text-6xl">Operational Procedures to keep the site secure
            </h1>
      ...
      <section class="text-gray-500 body-font bg-white">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="text-4xl mb-12 font-bold tracking-tight text-[#171A46] sm:text-5xl md:text-6xl ">Administrative Access to your Information
            </h1>
      ...
      <section class="text-gray-500 body-font bg-white">
        ...
        <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 class="text-4xl mb-12 font-bold tracking-tight text-[#171A46] sm:text-5xl md:text-6xl">Two Factor Authentication</h1>
