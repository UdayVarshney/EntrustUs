    ...
    return (
        <div className="bg-gradient-to-b from-purple-600 to-indigo-700 h-96 w-full">
            ...
            <div className="w-full flex items-center justify-center my-12 ">
                <div className="absolute top-40 bg-blue-900 shadow rounded py-12 lg:px-28 px-8 pl-0">
                    <div calssName = "w-full flex items-left justify-items-start my-12">
                    <p className="md:text-3xl text-xl font-bold leading-7 text-center text-white">Let’s chat and get a quote!</p>
                    <div className="md:flex flex-col items-left mt-12 ">
                        <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4">
                            <input tabIndex={0} arial-label="Please input name" type="name" className="text-base leading-none text-[#171A46] p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-500 sm:placeholder-red-400 md:placeholder-blue-400 lg:placeholder-green-400 xl:placeholder-orange-400" placeholder="name" />
                        </div>
                        <div className="md:w-72 flex flex-col md:ml-6 md:mt-0 mt-4 p-0">
                            <input tabIndex={0} arial-label="Please input email address" type="name" className="text-base leading-none text-[#171A46] p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-500 sm:placeholder-red-400 md:placeholder-blue-400 lg:placeholder-green-400 xl:placeholder-orange-400" placeholder="email" />
                        </div>
                    </div>
                    </div>
                   ...
                   <div className="md:flex items-center mt-8">
                    ...
                    <div class="absolute inset-y-0 right-0 w-16 md:w-72 flex flex-col md:ml-6 md: mt-20 pr-10 " >
                        <div className="w-full flex flex-col mt-8">
                            <textarea tabIndex={0} aria-label="leave a message" role="textbox" type="name" className="h-36 text-base leading-none text-[#171A46] p-3 focus:oultine-none focus:border-indigo-700 mt-4 bg-gray-100 border rounded border-gray-200 placeholder-gray-100 resize-none  sm:placeholder-red-400 md:placeholder-blue-400 lg:placeholder-green-400 xl:placeholder-orange-400" placeholder = "Message" defaultValue={""} />
                        </div>
                    </div>
